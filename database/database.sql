...
INSERT INTO `phppos_app_config` VALUES ('additional_payment_types',''),('automatically_email_receipt','0'),('averaging_method','moving_average'),('barcode_price_include_tax','0'),('calculate_average_cost_price_from_receivings','0'),('change_sale_date_when_completing_suspended_sale','0'),('change_sale_date_when_suspending','0'),('company','PHP Point Of Sale, LLC'),('currency_symbol','$'),('customers_store_accounts','0'),('date_format','middle_endian'),('default_payment_type','Cash'),('default_tax_1_name','Sales Tax'),('default_tax_1_rate',''),('default_tax_2_cumulative','0'),('default_tax_2_name','Sales Tax 2'),('default_tax_2_rate',''),('default_tax_3_name',''),('default_tax_3_rate',''),('default_tax_4_name',''),('default_tax_4_rate',''),('default_tax_5_name',''),('default_tax_5_rate',''),('default_tax_rate','8'),('disable_confirmation_sale','0'),('hide_signature','0'),('hide_dashboard_statistics', '0'),('hide_suspended_sales_in_reports','0'),('hide_store_account_payments_in_reports', '0'),('language','english'),('number_of_items_per_page','20'),('prices_include_tax','0'),('print_after_sale','0'),('return_policy','Change return policy'),('round_cash_on_sales','0'),('sale_prefix','POS'),('show_receipt_after_suspending_sale','0'),('time_format','12_hour'),('track_cash','0'),('version','14.1'),('website','');
...
INSERT INTO `phppos_employees` VALUES ('admin','439a6de57d475c1a0ba9bcb1c39f0af6',1,NULL,0);
...
INSERT INTO `phppos_permissions_actions` VALUES ('customers',1,'add_update'),('customers',1,'delete'),('customers',1,'search'),('employees',1,'add_update'),('employees',1,'assign_all_locations'),('employees',1,'delete'),('employees',1,'search'),('giftcards',1,'add_update'),('giftcards',1,'delete'),('giftcards',1,'search'),('item_kits',1,'add_update'),('item_kits',1,'delete'),('item_kits',1,'search'),('items',1,'add_update'),('items',1,'delete'),('items',1,'search'),('items',1,'see_cost_price'),('locations',1,'add_update'),('locations',1,'delete'),('locations',1,'search'),('reports',1,'view_categories'),('reports',1,'view_customers'),('reports',1,'view_deleted_sales'),('reports',1,'view_discounts'),('reports',1,'view_employees'),('reports',1,'view_giftcards'),('reports',1,'view_inventory_reports'),('reports',1,'view_item_kits'),('reports',1,'view_items'),('reports',1,'view_payments'),('reports',1,'view_profit_and_loss'),('reports',1,'view_receivings'),('reports',1,'view_register_log'),('reports',1,'view_sales'),('reports',1,'view_sales_generator'),('reports',1,'view_store_account'),('reports',1,'view_suppliers'),('reports',1,'view_taxes'),('sales',1,'delete_sale'),('sales',1,'delete_suspended_sale'),('sales',1,'edit_sale'),('sales',1,'edit_sale_price'),('sales',1,'give_discount'),('suppliers',1,'add_update'),('suppliers',1,'delete'),('suppliers',1,'search');
...
-- Dump completed on 2014-04-20 10:20:29
